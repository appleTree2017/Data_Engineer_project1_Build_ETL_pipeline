...
def process_song_file(cur, filepath):
    ...
    # song_data = {"num_songs": 1, "song_id": "SOUPIRU12A6D4FA1E1", "title": "Der Kleine Dompfaff", "duration": 152.92036, "year": 0}
    cur.execute(song_table_insert, song_data)

    # insert artist record
    # artist_data = {"artist_id": "ARJIE2Y1187B994AB7", "artist_latitude": null, "artist_longitude": null, "artist_location": "", "artist_name": "Line Renaud", }
