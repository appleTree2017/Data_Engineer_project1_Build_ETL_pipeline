...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id serial primary key NOT NULL, start_time bigint NOT NULL, user_id int not null, level varchar,song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar)
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artist   (artist_id varchar PRIMARY KEY NOT NULL, name varchar, location varchar, latitude varchar, longitude varchar)
""")

time_table_create = ("""Create Table IF NOT EXISTS time(start_time bigint primary key NOT NULL, hour int, day int, week int, month int, year int, weekday varchar)
""")
